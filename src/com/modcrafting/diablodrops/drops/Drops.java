...
public class Drops {
	...
	public Material[] armorPicker(){
		switch(gen.nextInt(6)){
			case 1: return diamondArmor();
			case 2: return ironArmor();
			case 3: return chainmailArmor();
			case 4: return goldArmor();
			case 5: return leatherArmor();
			default: return null;
		}
	}
	...
	public Material weaponPicker(){
		...
		case 0: return diamondWeapon(gen.nextInt(5));
		case 1: return ironWeapon(gen.nextInt(5));
		case 2: return goldWeapon(gen.nextInt(5));
		case 3: return woodWeapon(gen.nextInt(5));
		case 4: return Material.BOW;
		default: return null;
		}
	}
	...
	public Material getHelmet(){
		switch(gen.nextInt(6)){
			case 0: return Material.LEATHER_HELMET;
	...
	public Material getChestPlate(){
		switch(gen.nextInt(6)){
			case 0: return Material.LEATHER_CHESTPLATE;
	...
	public Material getLeggings(){
		switch(gen.nextInt(6)){
			case 0: return Material.LEATHER_LEGGINGS;
